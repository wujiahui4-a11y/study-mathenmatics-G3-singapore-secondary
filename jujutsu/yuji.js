  ...
  function stepDivergent(a, dt) {
    ...
    if (a.t >= .40 && a.stage < 1) {                 // the fist arrives
      ...
      inFront(4.4).forEach(function (e) {
        ...
        e.damage(6 * boost(), aim().multiplyScalar(5).setY(3),
    ...
    if (a.t >= .62 && a.stage < 2) {                 // and the rest of it
      ...
      inFront(6.5, 4.6).forEach(function (e) {
        e.damage(8 * boost(), aim().multiplyScalar(34).setY(15),
  ...
  function stepBlackFlash(a, dt) {
    ...
    if (a.t >= .74 && a.stage < 2) {
      ...
      hits.forEach(function (e) {
        e.damage(15 * boost(), aim().multiplyScalar(46).setY(20),
  ...
  function stepManji(a, dt) {
    ...
    if (a.t >= .42 && a.stage < 1) {
      ...
      inFront(4.6, 3.6).forEach(function (e) {
        ...
        e.damage(13 * boost(), kb, { react: 'head', reactDur: .6, spark: 0xff9fb0 });
      });
      try { sfx.hit(); } catch (e) {}
    }
  }
  ...
  function stepCrush(a, dt) {
    ...
    if (a.t >= .74 && a.stage < 1) {
      ...
      enemies.forEach(function (e) {
        ...
        d.y = 16;
        e.damage(12 * boost() * (1.1 - dist / 9 * .4), d,
  ...
  function stepSurge(a, dt) {
    if (a.t >= .22 && a.stage < 1) {
      ...
      enemies.forEach(function (e) {
        ...
        d.y = 13;
        e.damage(28 * boost(), d, { react: 'stagger', reactDur: .6, spark: 0xff7f9a });
      });
    }
  }
